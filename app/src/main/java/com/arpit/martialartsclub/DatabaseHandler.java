...
public class DatabaseHandler extends SQLiteOpenHelper {
  ...
  public DatabaseHandler(Context context)
  {
    ...
    public void addMartialArt(MartialArt martialArtObject)
    {
        ...
        String addMartialArtSQLCommand = "insert into " + MARTIAL_ARTS_TABLE + " values( null, '" + martialArtObject.getMartialArtName()+
                "', '"+ martialArtObject.getMartialArtPrice() + "', '" + martialArtObject.getMartialArtColor() + "')";
    ...
    {
        SQLiteDatabase database = getWritableDatabase();
        String deleteMartialArtSQLCommand = "delete from " + MARTIAL_ARTS_TABLE + " where " +
                                                ID_KEY + " = " + id;
    ...
    {
        SQLiteDatabase database = getWritableDatabase();
        String modifyMartialArtSQLCommand = "update "  + MARTIAL_ARTS_TABLE + " set "  + NAME_KEY  + " = '" + martialArtName
            + "', " + PRICE_KEY + " = '" + martialArtPrice + "', " + COLOR_KEY + " = '" + martialArtColor + "' " + "where "
            + ID_KEY + " = " + martialArtID ;
    ...
    public ArrayList<MartialArt> returnAllMartialArtObjects()
    {
        ...
        while (cursor.moveToNext())
        {
            MartialArt currentMartialArtObject = new MartialArt(
                    ...
                    cursor.getDouble(2),cursor.getColumnName(3));
    ...
    public MartialArt returnMartialArtObjectByID(int id)
    {
        ...
        {
            martialArtObject = new MartialArt(Integer.parseInt(cursor.getString(0)), cursor.getString(1)
